...
<c:if test="${currentRole eq 'admin'}">
        ...
        <table id="my" class="table1" border="1" bordercolor="#f0f0f0">
            ...
            <tr>
                ...
                <td height="10px" class="columStud">
                    <div class="text">ДАТА ПОСТУПЛЕНИЯ</div>
                </td>
                <td height="10px" class="columStud">
            ...
            <c:forEach items="${students}" var="stud">
                <tr>
                    <td height="20px" id="row"><input type="checkbox" name="idStudent"
                                                        value="${stud.id}"/></td>
                    <td height="50px" align="center"  id="row2">${stud.name}</td>
                    <td height="50px" align="center" id="row3">${stud.surname}</td>
                    <td height="50px" width="150px" align="center" id="row5">${stud.date}</td>
                    <td height="50px" align="center" id="ro w4">${stud.group}</td>
