...
<c:if test="${currentRole eq 'admin'}">
            <button id="but13" type="submit"onclick="createSubject()" value="2">Создать дисциплину</button>
                <button id="but23" type="submit"  onclick="modifySubject()">Модифицировать дисциплину</button>
            <button id="but12" type="submit"  onclick="deleteSubject()">Удалить выбранные дисциплины</button>
            </c:if>   </li>

        <li id="tableDisc2">
            <div class="textStud2"> СПИСОК ДИСЦИПЛИН</div>
